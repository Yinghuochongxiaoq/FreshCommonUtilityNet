...
namespace FreshCommonUtility.Dapper
{
    ...
    public static partial class SimpleCRUD
    {
        ...
        public static Task<int> UpdateAsync<TEntity>(this IDbConnection connection, TEntity entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null, CancellationToken? token = null)
        {
