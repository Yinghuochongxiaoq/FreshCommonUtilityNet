...
//命名空间：FreshCommonUtilityNet.Image
//文件名称：ImageHelper
//创 建 人：FreshMan
//创建日期：2017/6/17 17:48:19
//用    途：记录类的用途
//======================================================================
#endregion
...
namespace FreshCommonUtility.Image
{
    /// <summary>
    /// 水印位置
    /// </summary>
    ...
    public class ImageHelper
    {
        ...
        public static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height, string mode, bool isaddwatermark, ImagePosition imagePosition, string waterImage = null, int quality = 75)
        {
            ...
            if (isaddwatermark)
            {
                ...
                System.Drawing.Image copyImage = System.Drawing.Image.FromFile(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, waterImage));
            ...
            EncoderParameter encoderParam = new EncoderParameter(Encoder.Quality, qualityArray);
