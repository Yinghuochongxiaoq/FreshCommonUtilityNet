...
{
    public class SimpleCrudForOracleTest
    {
        /// <summary>
        /// Db username
        /// </summary>
        ...
        public SimpleCrudForOracleTest(SimpleCRUD.Dialect dbtype, string userName = "FreshMan", string password = "qinxianbo", string hostname = "localhost", int port = 3306, string dbName = "testdb")
        {
            _userName = userName;
            _password = password;
            _hostName = hostname;
        ...
        public IDbConnection GetOpenConnection()
        {
            ...
            var oracleConnectionString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=183.230.101.143)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=tysh)));Persist Security Info=True;User ID=xns;Password=xns;";
            ...
            var dictionary = new Dictionary<string, string>()
            {
                ...
                { SimpleCRUD.Dialect.Oracle.ToString(), oracleConnectionString }
            };
        ...
        public void TestInsertWithSpecifiedTableName()
        {
            ...
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestInsertWithSpecifiedTableName", Age = 10 });
        ...
        public void TestInseretUsingGenericLimitedFields()
        {
            ...
            {
                //arrange
                var user = new User { Id = 1, Name = "User1", Age = 10, ScheduledDayOff = System.DayOfWeek.Thursday };
        ...
        public void TestInsertUsingGenericLimitedFieldsAsync()
        {
            ...
            {
                //arrange
                var user = new User { Id = 1, Name = "User1", Age = 10, ScheduledDayOff = System.DayOfWeek.Friday };
        ...
        public void TestSimpleGet()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestSimpleGet", Age = 18, ScheduledDayOff = System.DayOfWeek.Saturday, CreatedDate = new System.DateTime(2016, 2, 2) });
                var user = connection.Get<User>(id);
        ...
        public void TestDeleteById()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "UserTestDeleteById", Age = 18 });
                connection.Delete<User>(id);
        ...
        public void TestDeleteByObject()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestDeleteByObject", Age = 18 });
                var user = connection.Get<User>(id);
        ...
        public void TestSimpleGetList()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestSimpleGetList", Age = 18 });
                connection.Insert(new User { Id = 2, Name = "TestSimpleGetList", Age = 18 });
        ...
        public void TestFilteredGetList()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestFilteredGetList1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestFilteredGetList2", Age = 10 });
                connection.Insert(new User { Id = 3, Name = "TestFilteredGetList3", Age = 10 });
                connection.Insert(new User { Id = 4, Name = "TestFilteredGetList4", Age = 11 });
        ...
        public void TestFilteredWithSqlGetList()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestFilteredWithSQLGetList1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestFilteredWithSQLGetList2", Age = 10 });
                connection.Insert(new User { Id = 3, Name = "TestFilteredWithSQLGetList3", Age = 10 });
                connection.Insert(new User { Id = 4, Name = "TestFilteredWithSQLGetList4", Age = 11 });
        ...
        public void TestGetListWithNullWhere()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestGetListWithNullWhere", Age = 10 });
        ...
        public void TestGetListWithoutWhere()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestGetListWithoutWhere", Age = 10 });
        ...
        public void TestsGetListWithParameters()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestsGetListWithParameters1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestsGetListWithParameters2", Age = 10 });
                connection.Insert(new User { Id = 3, Name = "TestsGetListWithParameters3", Age = 10 });
                connection.Insert(new User { Id = 4, Name = "TestsGetListWithParameters4", Age = 11 });

                var user = connection.GetList<User>("where Age > " + SimpleCRUD.GetPreSqlParamer() + "Age", new { Age = 10 });
                user.Count().IsEqualTo(1);
                connection.Execute("Delete from Users");
            }
        }
        ...
        public void TestGetWithReadonlyProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestGetWithReadonlyProperty", Age = 10 });
                var user = connection.Get<User>(id);
        ...
        public void TestInsertWithReadonlyProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestInsertWithReadonlyProperty", Age = 10, CreatedDate = new DateTime(2001, 1, 1) });
                var user = connection.Get<User>(id);
        ...
        public void TestUpdateWithReadonlyProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestUpdateWithReadonlyProperty", Age = 10 });
                var user = connection.Get<User>(id);
                user.Age = 11;
        ...
        public void TestGetWithNotMappedProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestGetWithNotMappedProperty", Age = 10, NotMappedInt = 1000 });
                var user = connection.Get<User>(id);
        ...
        public void TestInsertWithNotMappedProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestInsertWithNotMappedProperty", Age = 10, CreatedDate = new DateTime(2001, 1, 1), NotMappedInt = 1000 });
                var user = connection.Get<User>(id);
                user.NotMappedInt.IsEqualTo(0);
                connection.Execute("Delete from Users");
            }
        ...
        public void TestUpdateWithNotMappedProperty()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestUpdateWithNotMappedProperty", Age = 10 });
                var user = connection.Get<User>(id);
                user.Age = 11;
                user.CreatedDate = new DateTime(2001, 1, 1);
        ...
        public void TestInsertWithSpecifiedKey()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new Car { CarId = 1, Make = "Honda", Model = "Civic" });
                connection.Delete<Car>(id);
                id.IsEqualTo(1);
            }
        }
        ...
        public void TestInsertWithExtraPropertiesShouldSkipNonSimpleTypesAndPropertiesMarkedEditableFalse()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new Car { CarId = 1, Make = "Honda", Model = "Civic", Users = new List<User> { new User { Id = 1, Age = 12, Name = "test" } } });
                connection.Delete<Car>(id);
        ...
        public void TestUpdate()
        {
            using (var connection = GetOpenConnection())
            {
                var newid = (int)connection.Insert(new Car { CarId = 1, Make = "Honda", Model = "Civic" });
        ...
        public void TestUpdateUsingGenericLimitedFields()
        {
            ...
            {
                //arrange
                var user = new User { Id = 1, Name = "User1", Age = 10, ScheduledDayOff = DayOfWeek.Friday };
        ...
        public void TestComplexTypesMarkedEditableAreSaved()
        {
            using (var connection = GetOpenConnection())
            {
                var id = (int)connection.Insert(new User { Id = 1, Name = "User", Age = 11, ScheduledDayOff = DayOfWeek.Friday });
        ...
        public void TestNullableSimpleTypesAreSaved()
        {
            using (var connection = GetOpenConnection())
            {
                var id = (int)connection.Insert(new User1 { Id = 1, Name = "User", Age = 11, ScheduledDayOff = 2 });
        ...
        public void TestNullableEnumInsert()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "Enum-y", Age = 10, ScheduledDayOff = DayOfWeek.Thursday });
        ...
        public void TestMultiInsertASync()
        {
            using (var connection = GetOpenConnection())
            {
                connection.InsertAsync(new User { Id = 1, Name = "TestMultiInsertASync1", Age = 10 });
                connection.InsertAsync(new User { Id = 2, Name = "TestMultiInsertASync2", Age = 10 });
                connection.InsertAsync(new User { Id = 3, Name = "TestMultiInsertASync3", Age = 10 });
                connection.InsertAsync(new User { Id = 4, Name = "TestMultiInsertASync4", Age = 11 });
        ...
        public void TestSimpleGetAsync()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestSimpleGetAsync", Age = 10 });
        ...
        public void TestDeleteByIdAsync()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "UserAsyncDelete", Age = 10 });
        ...
        public void TestDeleteByObjectAsync()
        {
            using (var connection = GetOpenConnection())
            {
                var id = connection.Insert(new User { Id = 1, Name = "TestDeleteByObjectAsync", Age = 10 });
                var user = connection.Get<User>(id);
        ...
        public void TestSimpleGetListAsync()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestSimpleGetListAsync1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestSimpleGetListAsync2", Age = 10 });
        ...
        public void TestFilteredGetListAsync()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestFilteredGetListAsync1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestFilteredGetListAsync2", Age = 10 });
                connection.Insert(new User { Id = 3, Name = "TestFilteredGetListAsync3", Age = 10 });
                connection.Insert(new User { Id = 4, Name = "TestFilteredGetListAsync4", Age = 11 });
        ...
        public void TestFilteredGetListParametersAsync()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestFilteredGetListParametersAsync1", Age = 10 });
                connection.Insert(new User { Id = 2, Name = "TestFilteredGetListParametersAsync2", Age = 10 });
                connection.Insert(new User { Id = 3, Name = "TestFilteredGetListParametersAsync3", Age = 10 });
                connection.Insert(new User { Id = 4, Name = "TestFilteredGetListParametersAsync4", Age = 11 });

                var user = connection.GetListAsync<User>("where Age = " + SimpleCRUD.GetPreSqlParamer() + "Age", new { Age = 10 });
                user.Result.Count().IsEqualTo(3);
                connection.Execute("Delete from Users");
            }
        }
        ...
        public void TestRecordCountAsync()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                do
                {
                    connection.Insert(new User { Id = x, Name = "Person " + x, Age = x, CreatedDate = DateTime.Now, ScheduledDayOff = DayOfWeek.Thursday });
                    x++;
                } while (x < 30);
        ...
        public void TestInsertWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                var itemId = connection.Insert(new StrangeColumnNames { Id = 1, Word = "InsertWithSpecifiedColumnName", StrangeWord = "Strange 1" });
                itemId.IsEqualTo(1);
        ...
        public void TestDeleteByObjectWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                var itemId = connection.Insert(new StrangeColumnNames { Id = 1, Word = "TestDeleteByObjectWithSpecifiedColumnName", StrangeWord = "Strange 1" });
        ...
        public void TestSimpleGetListWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                var id1 = connection.Insert(new StrangeColumnNames { Id = 1, Word = "TestSimpleGetListWithSpecifiedColumnName1", StrangeWord = "Strange 2", });
                var id2 = connection.Insert(new StrangeColumnNames { Id = 2, Word = "TestSimpleGetListWithSpecifiedColumnName2", StrangeWord = "Strange 3", });
        ...
        public void TestUpdateWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                var newid = (int)connection.Insert(new StrangeColumnNames { Id = 1, Word = "Word Insert", StrangeWord = "Strange Insert" });
        ...
        public void TestFilteredGetListWithSpecifiedColumnName()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new StrangeColumnNames { Id = 5, Word = "Word 5", StrangeWord = "Strange 1", });
                connection.Insert(new StrangeColumnNames { Id = 6, Word = "Word 6", StrangeWord = "Strange 2", });
                connection.Insert(new StrangeColumnNames { Id = 7, Word = "Word 7", StrangeWord = "Strange 2", });
                connection.Insert(new StrangeColumnNames { Id = 8, Word = "Word 8", StrangeWord = "Strange 2", });
        ...
        public void TestGetListPagedWithParameters()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var resultlist = connection.GetListPaged<User>(1, 30, "where Age > " + SimpleCRUD.GetPreSqlParamer() + "Age", null, new { Age = 14 });
        ...
        public void TestGetListPagedWithSpecifiedPrimaryKey()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                do
                {
                    connection.Insert(new StrangeColumnNames { Id = x, Word = "Word " + x, StrangeWord = "Strange " + x });
                    x++;
                } while (x < 30);
        ...
        public void TestGetListPagedWithWhereClause()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                do
                {
                    connection.Insert(new User { Id = x + 1, Name = "Person " + x, Age = x, CreatedDate = DateTime.Now, ScheduledDayOff = DayOfWeek.Thursday });
                    x++;
                } while (x < 30);
                ...
                resultlist.Skip(1).First().Name.IsEqualTo("Person 23");
            }
        }
        ...
        public void TestDeleteListWithParameters()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                connection.DeleteList<User>("where age >= " + SimpleCRUD.GetPreSqlParamer() + "Age", new { Age = 9 });
                var resultlist = connection.GetList<User>();
        ...
        public void TestGetListNullableWhere()
        {
            using (var connection = GetOpenConnection())
            {
                connection.Insert(new User { Id = 1, Name = "TestGetListWithoutWhere", Age = 10, ScheduledDayOff = DayOfWeek.Friday });
                connection.Insert(new User { Id = 2, Name = "TestGetListWithoutWhere", Age = 10 });
        ...
        public void IgnoreProperties()
        {
            using (var connection = GetOpenConnection())
            {
                ...
                var fromDapper = connection.Query<IgnoreColumns>("Select * from IgnoreColumns where Id = " + SimpleCRUD.GetPreSqlParamer() + "Id", new { id = itemId }).First();
                ...
                var allColumnDapper = connection.Query<IgnoreColumns>("Select IgnoreAll from IgnoreColumns where Id = " + SimpleCRUD.GetPreSqlParamer() + "Id", new { id = itemId }).First();
        ...
        public void TestMultithreading()
        {
            ...
            {
                list.Add(new Test { Id = i, Name = i.ToString() });
            }
